    ...
    <footer className="bg-background text-foreground py-16 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col items-center gap-8">
          ...
          <p className="text-sm text-foreground/70">021 433 0538 | 83 Main Road, Green Point, 8001</p>
          
          <div className="flex gap-6 mt-4">
            <a
              href="https://www.instagram.com/jasonbakerycpt/"
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/JasonBakeryCpt/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-foreground/70 hover:text-foreground transition-colors"
              aria-label="Facebook"
          ...
          <p className="text-center text-sm text-foreground/70 mt-8" data-testid="text-copyright">
            © {currentYear} Jason Bakery. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
